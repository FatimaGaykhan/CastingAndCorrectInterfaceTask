...
namespace Interface_Task.Services
{
    public class EmployeeService : IEmployeeService
    {
        ...
        public Employee[] Search(Employee[] employees, string text)
        {
            return employees.Where(m => m.Name.ToLower().Trim().Contains(text.ToLower().Trim())|| m.Surname.ToLower().Trim().Contains(text.ToLower().Trim())).ToArray();
        }
